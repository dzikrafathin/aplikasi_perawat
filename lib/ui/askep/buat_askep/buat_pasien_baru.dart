...
class HalamanBuatPasienBaru extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => PasienBaruBloc(pasienApi: PasienApi()),
        child: BlocListener<PasienBaruBloc, PasienBaruState>(
          child: _FormPasienBaru(),
          listener: (context, state) {
            switch (state.status) {
              case PasienBaruStatus.berhasil:
...
class _FormPasienBaru extends StatelessWidget {
  const _FormPasienBaru({
    Key? key,
  }) : super(key: key);
...
class _TombolKirim extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PasienBaruBloc, PasienBaruState>(
        bloc: BlocProvider.of<PasienBaruBloc>(context),
        builder: (context, state) {
          if (state.status == PasienBaruStatus.mengirim) {
            return Center(
            ...
            return ElevatedButton(
                onPressed: () {
                  BlocProvider.of<PasienBaruBloc>(context)
